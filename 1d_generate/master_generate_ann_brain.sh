...
WEIGHTS=("IMAGENET1K_V2") #("ResNet50_Weights.IMAGENET1K_V2")  IMAGENET1K_SWAG_E2E_V1
MODELS=("resnet50") #("resnet50") vit_b_16
TRAINED_MODEL_FILES=(197972) #(211379 210760) #(197894 197972) # 201512 (197894 197972)
NUM_GENERATION_STEPS=(10) # 250 400 500)
