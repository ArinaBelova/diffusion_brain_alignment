...
# Train
apptainer exec --nv --bind ${LOCAL_JOB_DIR},src:/opt/app/src,/data/datapool3/datasets/nsd_betas_condavg/,/data/datapool3/datasets/full_nsd_betas/,my_pycortex_db:/opt/conda/envs/diffusion_brain/share/pycortex/db \
