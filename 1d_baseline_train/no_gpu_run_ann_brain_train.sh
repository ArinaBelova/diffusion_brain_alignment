...
bash -c "python ${SLURM_SUBMIT_DIR}/src/diffusion_brain/scripts/train_sklearn.py --config ${SLURM_SUBMIT_DIR}/src/diffusion_brain/configs/brain/sklearn_config_train.yaml \
