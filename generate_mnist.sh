...
#SBATCH --job-name=cluster-generate-mnist
...
bash -c "python ${SLURM_SUBMIT_DIR}/src/diffusion_brain/scripts/generate.py --config ${SLURM_SUBMIT_DIR}/src/diffusion_brain/configs/mnist/config_generate.yaml --jobid ${SLURM_JOB_NAME}-${SLURM_JOB_ID}" 
